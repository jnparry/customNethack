...
const struct Role roles[] = {
    { { "Archeologist", 0 },
      ...
      MH_HUMAN | MH_DWARF | MH_GNOME | MH_HOBBIT | ROLE_MALE | ROLE_FEMALE | ROLE_LAWFUL
          | ROLE_NEUTRAL,
    ...
    { { "Barbarian", 0 },
      ...
      MH_HUMAN | MH_ELF | MH_ORC | ROLE_MALE | ROLE_FEMALE | ROLE_NEUTRAL
          | ROLE_CHAOTIC,
      /* Str Int Wis Dex Con Cha */
      { 16, 7, 7, 15, 16, 6 },
      { 30, 6, 7, 20, 30, 7 },
    ...
    { { "Caveman", "Cavewoman" },
      ...
      SPE_DIG,
      -4 },
    { { "Dragon Rider", 0 },				//needs to be finished
      { { "Gallant", 0 },
        { "Esquire", 0 },
        { "Bachelor", 0 },
        { "Sergeant", 0 },
      ...
      S_JELLY,
      ART_ASCALON,
      MH_HUMAN | MH_DWARF | MH_HOBBIT | ROLE_MALE | ROLE_FEMALE | ROLE_LAWFUL,
      // Str Int Wis Dex Con Cha 
      { 13, 7, 14, 8, 10, 17 },
      { 30, 15, 15, 10, 20, 10 },
      // Init   Lower  Higher 
    ...
    { { "Flame Mage", 0 },        //Finished
      ...
      MH_HUMAN | MH_ELF | MH_GNOME | MH_HOBBIT | MH_ORC | ROLE_MALE
    ...
    { { "Gunslinger", 0 },				//Haven't started
      ...
      S_XORN,
      ART_PIECEMAKER,
      MH_HUMAN | MH_GNOME | MH_HOBBIT | MH_ORC | ROLE_FEMALE | ROLE_NEUTRAL | ROLE_CHAOTIC,
      // Str Int Wis Dex Con Cha
      { 10, 7, 7, 7, 10, 7 },
      { 30, 6, 7, 20, 30, 7 },
      // Init   Lower  Higher
    ...
    { { "Healer", 0 },
      ...
      MH_HUMAN | MH_GNOME | MH_HOBBIT | ROLE_MALE | ROLE_FEMALE | ROLE_NEUTRAL,
      /* Str Int Wis Dex Con Cha */
      { 7, 7, 13, 7, 11, 16 },
      { 15, 20, 20, 15, 25, 5 },
      /* Init   Lower  Higher */
    ...
    { { "Monk", 0 },
      ...
      MH_HUMAN | MH_HOBBIT | ROLE_MALE | ROLE_FEMALE | ROLE_LAWFUL | ROLE_NEUTRAL
          | ROLE_CHAOTIC,
      /* Str Int Wis Dex Con Cha */
      { 10, 7, 8, 8, 7, 7 },
      { 25, 10, 20, 20, 15, 10 },
    ...
    { { "Naked", 0 },						//Needs to be finished
      ...
      S_ELEMENTAL,
      S_XORN,
      ART_TATTORED_RAIMENT,
      MH_HUMAN | MH_ELF | MH_GNOME | MH_DWARF | MH_HOBBIT | MH_ORC | ROLE_MALE | ROLE_FEMALE
    ...
    { { "Priest", "Priestess" },
      ...
      MH_HUMAN | MH_ELF | MH_HOBBIT | ROLE_MALE | ROLE_FEMALE | ROLE_LAWFUL | ROLE_NEUTRAL
          | ROLE_CHAOTIC,
      /* Str Int Wis Dex Con Cha */
      { 7, 7, 10, 7, 7, 7 },
      { 15, 10, 30, 15, 20, 10 },
    ...
    { { "Ranger", 0 },
      ...
      MH_HUMAN | MH_ELF | MH_GNOME | MH_HOBBIT | MH_ORC | ROLE_MALE | ROLE_FEMALE
	...
	{ { "Undead Slayer", 0 },			//Finished
      ...
      MH_HUMAN | MH_ELF | MH_GNOME | MH_HOBBIT | MH_ORC | ROLE_FEMALE
          | ROLE_LAWFUL | ROLE_NEUTRAL | ROLE_CHAOTIC, //| MH_WERE 
      // Str Int Wis Dex Con Cha
      { 13, 7, 14, 8, 10, 10 },
      { 20, 15, 15, 10, 20, 10 },
      // Init   Lower  Higher
