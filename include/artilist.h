...
STATIC_OVL NEARDATA struct artifact artilist[] = {
	...
	A("Serpent's Tongue", KNIFE, SPFX_RESTR, 0, 0, PHYS(2, 3), NO_DFNS,
      NO_CARY, 0, A_CHAOTIC, PM_GUNSLINGER, NON_PM, 400L),

	A("Luckblade", SHORT_SWORD, (SPFX_RESTR | SPFX_LUCK), 0, 0, PHYS(5, 5),
      NO_DFNS, NO_CARY, 0, A_NEUTRAL, NON_PM, PM_GNOME, 1000L),

    A("Sword of Balance", SILVER_SHORT_SWORD, (SPFX_RESTR | SPFX_DALIGN), 0,
      0, PHYS(2, 5), NO_DFNS, NO_CARY, 0, A_NEUTRAL, NON_PM, NON_PM, 5000L),

    A("Quick Blade", ELVEN_SHORT_SWORD, SPFX_RESTR, 0, 0, PHYS(9, 2), NO_DFNS,
      NO_CARY, 0, A_LAWFUL, NON_PM, NON_PM, 1000L),

	A("Reaper", HALBERD, SPFX_RESTR, 0, 0, PHYS(5, 20), NO_DFNS, NO_CARY, 0,
      A_LAWFUL, NON_PM, NON_PM, 1000L),

    A("Evilbane", HALBERD, (SPFX_RESTR | SPFX_DALIGN), 0, 0, PHYS(5, 12),
      NO_DFNS, NO_CARY, 0, A_LAWFUL, PM_YEOMAN, NON_PM, 100L),

	A("Skullcrusher", CLUB, SPFX_RESTR, 0, 0, PHYS(3, 10), NO_DFNS, NO_CARY,
      0, A_LAWFUL, PM_CAVEMAN, NON_PM, 300L),

	A("Bat from Hell", BASEBALL_BAT, (SPFX_RESTR), 0, 0, PHYS(3, 20), NO_DFNS,
      NO_CARY, 0, A_CHAOTIC, NON_PM, NON_PM, 5000L),

	A("Gauntlets of Defense", GAUNTLETS_OF_DEXTERITY, SPFX_RESTR, SPFX_HPHDAM,
      0, NO_ATTK, NO_DFNS, NO_CARY, INVIS, A_NEUTRAL, PM_MONK, NON_PM, 5000L),
    ...
    A("Plague", DARK_ELVEN_BOW, /* KMH */
      ...
      A_CHAOTIC, NON_PM, PM_ELF, 6000L),

    A("Hellfire", CROSSBOW, /* WAC */
      (SPFX_RESTR | SPFX_DEFN), 0, 0, PHYS(5, 7), FIRE(0, 0), NO_CARY, 0,
      A_NEUTRAL, NON_PM, PM_GNOME, 4000L),
	...
	A("The Master of Ceremonies Whip", SILVER_WHIP_SWORD,
      (SPFX_NOGEN | SPFX_RESTR | SPFX_INTEL), SPFX_REGEN, 0, PHYS(5, 0),
      NO_DFNS, CARY(AD_FIRE), TAMING, A_CHAOTIC, PM_BEAST_TAMER,
      NON_PM, 2500L, NO_COLOR),
...
A("The Palantir of Westernesse",        CRYSTAL_BALL,
	...
	A("Ascalon", LANCE,
      ...
      SPFX_WARN, 0, PHYS(5, 5), DFNS(AD_MAGM),
      NO_CARY, 0, A_LAWFUL, PM_DRAGON_RIDER, NON_PM, 3500L, NO_COLOR),
	...
	A("The Candle of Eternal Flame", MAGIC_CANDLE,
      ...
      PM_FLAME_MAGE, NON_PM, 50000L),

	A("Piecemaker", PISTOL,
      (SPFX_NOGEN | SPFX_RESTR | SPFX_INTEL | SPFX_REFLECT), SPFX_ESP, 0,
      PHYS(5, 0), NO_DFNS, NO_CARY, CREATE_AMMO, A_CHAOTIC, PM_GUNSLINGER, NON_PM,
      4000L, NO_COLOR),
	...
	A("The Storm Whistle", MAGIC_WHISTLE,
      (SPFX_NOGEN | SPFX_RESTR | SPFX_INTEL), (SPFX_WARN | SPFX_TCTRL), 0,
      NO_ATTK, NO_DFNS, CARY(AD_FIRE), SUMMON_WATER_ELEMENTAL, A_LAWFUL,
      PM_ICE_MAGE, NON_PM, 1000L),
	...
	A("Tattored Raiment", T_SHIRT,
      (SPFX_NOGEN | SPFX_RESTR | SPFX_INTEL | SPFX_XRAY), SPFX_ESP, 0, NO_ATTK,
      DFNS(AD_MAGM), NO_CARY, HEALING, A_NEUTRAL, PM_NAKED, NON_PM, 2500L,
      NO_COLOR),
    ...
    A("Flail of Furry", FLAIL,
      (SPFX_NOGEN | SPFX_RESTR | SPFX_INTEL | SPFX_PROTECT), SPFX_HPHDAM, 0,
      PHYS(5, 15), NO_DFNS, CARY(AD_CONF), ENERGY_BOOST, A_CHAOTIC, PM_SHINOBI,
      NON_PM, 4500L, NO_COLOR),
	...
	A("The Stake of Van Helsing", WOODEN_STAKE,
      (SPFX_NOGEN | SPFX_RESTR | SPFX_INTEL), 0, 0, PHYS(5, 12), NO_DFNS,
      CARY(AD_MAGM), 0, A_LAWFUL, PM_UNDEAD_SLAYER, NON_PM, 5000L),
	...
	A("The Crown of Saint Edward", HELM_OF_TELEPATHY,
      (SPFX_NOGEN | SPFX_RESTR | SPFX_INTEL), (SPFX_HSPDAM), 0, NO_ATTK,
      NO_DFNS, CARY(AD_MAGM), 0, A_LAWFUL, PM_YEOMAN, NON_PM, 5000L),
